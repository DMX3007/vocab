...
const PATHS: Record<string, React.ReactNode> = {
  ...
  volume: <><path d="M2.5 6.5v3h2.3L8 12.2V3.8L4.8 6.5z" fill="currentColor" stroke="none" /><path d="M10.3 6c.7.5 1.2 1.3 1.2 2.2s-.5 1.7-1.2 2.2" /><path d="M11.8 4.2c1.3.9 2.2 2.4 2.2 4.1s-.9 3.2-2.2 4.1" /></>,
  shuffle: <>
